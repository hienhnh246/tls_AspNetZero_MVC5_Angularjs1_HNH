...
using triluatsoft.tls.Web.App.Startup;//SPA!
using triluatsoft.tls.Web.Bundling;
using triluatsoft.tls.Web.Navigation;
using triluatsoft.tls.Web.Routing;
using triluatsoft.tls.WebApi;
...
namespace triluatsoft.tls.Web
{
    ...
    public class tlsWebModule : AbpModule
    {
