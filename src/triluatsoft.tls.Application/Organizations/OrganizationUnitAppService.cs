...
using triluatsoft.tls.Organizations.Dto;
using System.Linq.Dynamic;

namespace triluatsoft.tls.Organizations
{
    [AbpAuthorize(AppPermissions.Pages_Administration_OrganizationUnits)]
    public class OrganizationUnitAppService : tlsAppServiceBase, IOrganizationUnitAppService
    {
